...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public int age;
    public String race,active;
    public Spinner ageView,genderView,raceView,physicallyActiveView;
    /**
    ...
    // UI references.
    private AutoCompleteTextView mEmailView,name;
    private EditText mPasswordView,weightView,heightView,waistView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        raceView=(Spinner)findViewById(R.id.race);
        physicallyActiveView=(Spinner)findViewById(R.id.active);
        ...
        List races=new ArrayList<String>();
        List yesNoChoice=new ArrayList<String>();
        genders.add("Male");
        genders.add("Female");
        genders.add("Other");
        races.add("Black");
        ...
        ageView.setAdapter(spinnerArrayAdapter);
        ...
        ArrayAdapter<String> raceArrayAdapter = new ArrayAdapter<String>(
        ...
        raceView.setAdapter(raceArrayAdapter);

        ArrayAdapter<String> activeArrayAdapter = new ArrayAdapter<String>(
                this, android.R.layout.simple_spinner_item, yesNoChoice);
        raceArrayAdapter.setDropDownViewResource( android.R.layout.simple_spinner_dropdown_item );
        physicallyActiveView.setAdapter(activeArrayAdapter);
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    final String age = ageView.getSelectedItem().toString();
                    final String email = mEmailView.getText().toString();
                    final String password = mPasswordView.getText().toString();
                    final String gender = genderView.getSelectedItem().toString();
                    final String height = heightView.getText().toString();
                    final String weight = weightView.getText().toString();
                    final String waist=waistView.getText().toString();
                    final String race=raceView.getSelectedItem().toString();
                    final String active=physicallyActiveView.getSelectedItem().toString();
                    final double dWeight = Double.parseDouble(weight);
                    final double dHeight = Double.parseDouble(height);
                    final double bmi = dWeight / ((dHeight / 100) * (dHeight / 100));
                    double bmr=0;
                    ...
                    final String bmrString=Double.toString(bmr);
                    helper.setProfile(myname,"",email,weight,age,height,Double.toString(bmi),"",waist,race,active,Double.toString(bmr),gender);
                    final ProgressDialog pDialog = new ProgressDialog(RegisterActivity.this);
                    pDialog.setMessage("Adding Your Information...");
                    pDialog.show();
                    try {
                        String url = helper.getBaseUrl() + "classify.php";
                        StringRequest postRequest2 = new StringRequest(Request.Method.POST, url,
                                new Response.Listener<String>() {
                                    ...
                                    public void onResponse(String response) {
                                        try {
                                            ...
                                            String risk = jsonResponse.getString("result");
                            ...
                            protected Map<String, String> getParams() {
                                ...
                                params.put("bmr", bmrString);

                                //params.put("obese", obese);
                                params.put("bmi", Double.toString(bmi));
                                return params;
                            }
                        };
                        postRequest2.setRetryPolicy(new DefaultRetryPolicy(80000, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
                        Volley.newRequestQueue(RegisterActivity.this).add(postRequest2);
                    ...
                    i.putExtra("risk", helper.getRisk());
                    startActivity(i);
